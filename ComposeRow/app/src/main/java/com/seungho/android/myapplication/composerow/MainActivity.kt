package com.seungho.android.myapplication.composerow
...
import com.seungho.android.myapplication.composerow.ui.theme.ComposeRowTheme
...
// 컨테이너성격의 Composable 에서 요소들의 아이템을 정렬할 떄 사용합니다.
...
// alignment 는 말그대로 해당 컨테이너 안에 들어있는 요소들의 위치를 어떠한 방향
// linearLayout 에서 gravity 와 동일 하다고 보시면 됩니다.
// Alignment.Bottom : 컨테이너의 아래에 두기
// Alignment.Top : 컨테이너의 위에 두기
// 현재는 Row 콤포저블 안에서 align 이 들어가기 때문에 Center Vertically
